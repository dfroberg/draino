...
## Usage
```
$ docker run dfroberg/draino /draino --help
...
Draino is automatically built from master and pushed to the [Docker Hub](https://hub.docker.com/r/dfroberg/draino/).
Builds are tagged `dfroberg/draino:$(git rev-parse --short HEAD)`.

**Note:** As of September, 2020 we no longer publish `dfroberg/draino:latest`
